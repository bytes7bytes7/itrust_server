...
import 'package:itrust_server/src/features/common/application/services/hash_service.dart'
    as _i14;
import 'package:itrust_server/src/features/common/common.dart' as _i87;
...
import 'package:itrust_server/src/repositories/interfaces/post_repository.dart'
    as _i51;
import 'package:itrust_server/src/utils/jwt_settings.dart' as _i37;
import 'package:json_annotation/json_annotation.dart' as _i26;
import 'package:mapster/mapster.dart' as _i43;
import 'package:mediator/mediator.dart' as _i46;

import '../../../env/env_module.dart' as _i89;
import '../third_party/mapster_module.dart' as _i90;
import '../third_party/mediator_module.dart' as _i91;
...
_i1.GetIt init(
  ...
  gh.singleton<
          _i16.JsonConverter<_i23.GetDevicesRequest, Map<String, Object?>>>(
      _i24.GetDevicesRequestJsonConverter());
  gh.singleton<
      _i16.JsonConverter<_i23.ChangePersonalInfoRequest,
  ...
  gh.singleton<
          _i16.JsonConverter<_i28.GetUserByIDRequest, Map<String, Object?>>>(
      _i29.GetUserByIDRequestJsonConverter());
  gh.singleton<
          _i16.JsonConverter<_i28.GetUserByNickRequest, Map<String, Object?>>>(
      _i30.GetUserByNickRequestJsonConverter());
  gh.singleton<
          _i16.JsonConverter<_i23.RemoveDeviceRequest, Map<String, Object?>>>(
  ...
  gh.singleton<_i16.JsonConverter<_i17.LikePostRequest, Map<String, Object?>>>(
  ...
  gh.singleton<_i40.LikePostCommandValidator>(_i40.LikePostCommandValidator());
  ...
  gh.singleton<_i44.MediaRepository>(
    _i45.TestMediaRepository(),
    registerFor: {_test},
  );
  gh.singleton<_i46.Mediator>(mediatorModule.mediator);
  gh.singleton<_i7.PasswordHashRepository>(
    _i47.TestPasswordHashRepository(),
    registerFor: {_test},
  );
  gh.factory<_i48.PostController>(() => _i48.PostController(
        mediator: gh<_i46.Mediator>(),
        mapster: gh<_i43.Mapster>(),
      ));
  gh.singleton<_i49.PostMapsterRegistrar>(
      _i49.PostMapsterRegistrar(gh<_i43.Mapster>())..register());
  gh.singleton<_i50.PostMediatorRegistrar>(
      _i50.PostMediatorRegistrar(gh<_i46.Mediator>())..register());
  gh.singleton<_i51.PostRepository>(
    _i52.TestPostRepository(
      dateTimeProvider: gh<_i53.DateTimeProvider>(),
      mediaRepository: gh<_i44.MediaRepository>(),
    ),
    registerFor: {_test},
  );
  gh.singleton<_i54.RefreshTokenCommandValidator>(
      _i54.RefreshTokenCommandValidator());
  gh.singleton<_i55.RegisterCommandValidator>(_i55.RegisterCommandValidator());
  gh.singleton<_i56.RemoveDeviceCommandValidator>(
      _i56.RemoveDeviceCommandValidator());
  gh.singleton<_i7.StaffUserRepository>(
    _i57.TestStaffUserRepository(),
    registerFor: {_test},
  );
  ...
  gh.factory<_i59.UserController>(() => _i59.UserController(
        mediator: gh<_i46.Mediator>(),
        mapster: gh<_i43.Mapster>(),
      ));
  gh.singleton<_i60.UserMapsterRegistrar>(
      _i60.UserMapsterRegistrar(gh<_i43.Mapster>())..register());
  gh.singleton<_i61.UserMediatorRegistrar>(
      _i61.UserMediatorRegistrar(gh<_i46.Mediator>())..register());
  gh.singleton<_i62.VerifyTokenQueryHandler>(_i62.VerifyTokenQueryHandler(
    jwtTokenService: gh<_i63.JwtTokenService>(),
    tokenRepository: gh<_i7.TokenRepository>(),
  ));
  gh.singleton<_i64.VerifyTokenQueryValidator>(
      _i64.VerifyTokenQueryValidator());
  gh.factory<_i65.AccountController>(() => _i65.AccountController(
        mediator: gh<_i46.Mediator>(),
        mapster: gh<_i43.Mapster>(),
      ));
  gh.singleton<_i66.AccountMapsterRegistrar>(
      _i66.AccountMapsterRegistrar(gh<_i43.Mapster>())..register());
  gh.singleton<_i67.AccountMediatorRegistrar>(
      _i67.AccountMediatorRegistrar(gh<_i46.Mediator>())..register());
  gh.factory<_i68.AuthController>(() => _i68.AuthController(
        mediator: gh<_i46.Mediator>(),
        mapster: gh<_i43.Mapster>(),
      ));
  gh.singleton<_i69.AuthMapsterRegistrar>(
      _i69.AuthMapsterRegistrar(gh<_i43.Mapster>())..register());
  gh.singleton<_i70.AuthMediatorRegistrar>(
      _i70.AuthMediatorRegistrar(gh<_i46.Mediator>())..register());
  gh.singleton<_i71.ChangePersonalInfoCommandHandler>(
      _i71.ChangePersonalInfoCommandHandler(
          endUserRepository: gh<_i7.EndUserRepository>()));
  gh.singleton<_i72.CommonMapsterRegistrar>(
      _i72.CommonMapsterRegistrar(gh<_i43.Mapster>())..register());
  gh.singleton<_i73.CreatePostCommandHandler>(_i73.CreatePostCommandHandler(
    postRepository: gh<_i7.PostRepository>(),
    mediaRepository: gh<_i7.MediaRepository>(),
    mapster: gh<_i43.Mapster>(),
  ));
  gh.factory<_i74.FeedController>(() => _i74.FeedController(
        mediator: gh<_i46.Mediator>(),
        mapster: gh<_i43.Mapster>(),
      ));
  gh.singleton<_i75.FeedMapsterRegistrar>(
      _i75.FeedMapsterRegistrar(gh<_i43.Mapster>())..register());
  gh.singleton<_i76.FeedMediatorRegistrar>(
      _i76.FeedMediatorRegistrar(gh<_i46.Mediator>())..register());
  gh.singleton<_i77.GetDevicesQueryHandler>(_i77.GetDevicesQueryHandler(
    tokenRepository: gh<_i7.TokenRepository>(),
    mapster: gh<_i43.Mapster>(),
  ));
  gh.singleton<_i78.GetFeedQueryHandler>(_i78.GetFeedQueryHandler(
    postRepository: gh<_i7.PostRepository>(),
    mediaRepository: gh<_i7.MediaRepository>(),
    mapster: gh<_i43.Mapster>(),
  ));
  gh.singleton<_i79.GetPostQueryHandler>(_i79.GetPostQueryHandler(
    postRepository: gh<_i7.PostRepository>(),
    mediaRepository: gh<_i7.MediaRepository>(),
    mapster: gh<_i43.Mapster>(),
  ));
  gh.singleton<_i80.GetUserByIDQueryHandler>(_i80.GetUserByIDQueryHandler(
    endUserRepository: gh<_i7.EndUserRepository>(),
    staffUserRepository: gh<_i7.StaffUserRepository>(),
  ));
  gh.singleton<_i81.GetUserByNickQueryHandler>(_i81.GetUserByNickQueryHandler(
    endUserRepository: gh<_i7.EndUserRepository>(),
    staffUserRepository: gh<_i7.StaffUserRepository>(),
  ));
  gh.singleton<_i82.LikePostCommandHandler>(_i82.LikePostCommandHandler(
    postRepository: gh<_i7.PostRepository>(),
    mediaRepository: gh<_i7.MediaRepository>(),
    mapster: gh<_i43.Mapster>(),
  ));
  ...
  gh.singleton<_i85.RefreshTokenCommandHandler>(_i85.RefreshTokenCommandHandler(
    jwtTokenService: gh<_i63.JwtTokenService>(),
    tokenRepository: gh<_i7.TokenRepository>(),
    endUserRepository: gh<_i7.EndUserRepository>(),
    dateTimeProvider: gh<_i53.DateTimeProvider>(),
  ));
  gh.singleton<_i86.RegisterCommandHandler>(_i86.RegisterCommandHandler(
    jwtTokenService: gh<_i63.JwtTokenService>(),
    hashService: gh<_i87.HashService>(),
    endUserRepository: gh<_i7.EndUserRepository>(),
    passwordHashRepository: gh<_i7.PasswordHashRepository>(),
    tokenRepository: gh<_i7.TokenRepository>(),
    dateTimeProvider: gh<_i87.DateTimeProvider>(),
  ));
  gh.singleton<_i88.RemoveDeviceCommandHandler>(_i88.RemoveDeviceCommandHandler(
    tokenRepository: gh<_i7.TokenRepository>(),
    passwordHashRepository: gh<_i7.PasswordHashRepository>(),
    endUserRepository: gh<_i7.EndUserRepository>(),
...
class _$EnvModule extends _i89.EnvModule {}

class _$MapsterModule extends _i90.MapsterModule {}

class _$MediatorModule extends _i91.MediatorModule {}
