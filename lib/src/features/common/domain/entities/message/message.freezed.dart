...
abstract class $MessageCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {MessageID id, ChatID chatID, DateTime sentAt, DateTime? willBeBurntAt});
...
class _$InfoMessage implements InfoMessage {
  ...
  @override
  String toString() {
    return 'Message.info(id: $id, chatID: $chatID, sentAt: $sentAt, markUp: $markUp, markUpData: $markUpData, willBeBurntAt: $willBeBurntAt)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, chatID, sentAt, markUp,
      const DeepCollectionEquality().hash(_markUpData), willBeBurntAt);
  ...
  TResult when<TResult extends Object?>({
    ...
    return info(id, chatID, sentAt, markUp, markUpData, willBeBurntAt);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return info?.call(id, chatID, sentAt, markUp, markUpData, willBeBurntAt);
  }
...
class _$UserMessage implements UserMessage {
  ...
  @override
  String toString() {
    return 'Message.user(id: $id, chatID: $chatID, senderID: $senderID, sentAt: $sentAt, text: $text, mediaIDs: $mediaIDs, willBeBurntAt: $willBeBurntAt, modifiedAt: $modifiedAt)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return user(id, chatID, senderID, sentAt, text, mediaIDs, willBeBurntAt,
        modifiedAt);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return user?.call(id, chatID, senderID, sentAt, text, mediaIDs,
